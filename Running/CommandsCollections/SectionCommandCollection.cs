...
{
    internal class SectionCommandCollection : CommandCollection, IObjectCommandCollection<Section>
    {
        public SectionCommandCollection(CommandManager manager)
        {
        ...
        Section IObjectCommandCollection<Section>.GetObject()
        => this.GetObject();
